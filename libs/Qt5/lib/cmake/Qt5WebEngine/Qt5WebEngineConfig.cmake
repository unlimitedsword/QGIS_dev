...
set(Qt5WebEngine_VERSION_STRING 5.15.17)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.15.17"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.15.17/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt5WebEngine_FIND_VERSION_EXACT}
